...
class CollectiondetailedrecordpagetabsData(DataSet):
    ...
    class Collectiondetailedrecordpagetabs_8:
        ...
        collection = CollectionData.pictures

    class Collectiondetailedrecordpagetabs_17:
        tabs = u'usage;comments;metadata'
        collection = CollectionData.multimediaArts

    class Collectiondetailedrecordpagetabs_18:
        tabs = u'usage;comments;metadata'
        collection = CollectionData.poetry

    class Collectiondetailedrecordpagetabs_19:
        tabs = u'usage;comments;metadata'
        collection = CollectionData.atlantisTimesNews

    class Collectiondetailedrecordpagetabs_33:
        tabs = u''
        collection = CollectionData.videos
...
class CollectionExampleData(DataSet):
    ...
    #    id_example = None
    #    score = 27
    #    collection = CollectionData.articlesPreprints

    class CollectionExample_15_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_19:
        example = ExampleData.Example_19
        score = 0
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_2:
        example = ExampleData.Example_2
        score = 8
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_3:
        example = ExampleData.Example_3
        score = 60
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_4:
        example = ExampleData.Example_4
        score = 40
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_5:
        example = ExampleData.Example_5
        score = 2
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_6:
        example = ExampleData.Example_6
        score = 4
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_7:
        example = ExampleData.Example_7
        score = 5
        collection = CollectionData.articlesPreprints

    class CollectionExample_15_8:
        example = ExampleData.Example_8
        score = 3
        collection = CollectionData.articlesPreprints
    ...
    class CollectionExample_16_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.booksReports
    ...
    class CollectionExample_17_14:
        example = ExampleData.Example_14
        score = 10
        collection = CollectionData.multimediaArts

    class CollectionExample_17_15:
        example = ExampleData.Example_15
        score = 20
        collection = CollectionData.multimediaArts

    class CollectionExample_17_16:
        example = ExampleData.Example_16
        score = 30
        collection = CollectionData.multimediaArts
    ...
    class CollectionExample_1_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.siteCollection

    class CollectionExample_1_13:
        example = ExampleData.Example_13
        score = 50
        collection = CollectionData.siteCollection
    ...
    class CollectionExample_2_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.preprints
    ...
    class CollectionExample_3_17:
        example = ExampleData.Example_17
        score = 10
        collection = CollectionData.books

    class CollectionExample_3_18:
        example = ExampleData.Example_18
        score = 20
        collection = CollectionData.books
    ...
    class CollectionExample_4_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.theses
    ...
    class CollectionExample_5_1:
        example = ExampleData.Example_1
        score = 1
        collection = CollectionData.reports
    ...
    #    exam
    #    score = 27
    #    collection = CollectionData.articles
...
class CollectionPortalboxData(DataSet):
    ...
    class CollectionPortalbox_10_16_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_16
        score = 100
        collection = CollectionData.CERNExperiments

    class CollectionPortalbox_11_17_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_17
        score = 100
        collection = CollectionData.theoreticalPhysics

    class CollectionPortalbox_12_18_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_18
        score = 100
        collection = CollectionData.experimentalPhysics

    class CollectionPortalbox_13_19_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_19
        score = 100
        collection = CollectionData.ISOLDE

    class CollectionPortalbox_14_20_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_20
        score = 100
        collection = CollectionData.ALEPH

    class CollectionPortalbox_15_21_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_21
        score = 100
        collection = CollectionData.articlesPreprints
    ...
    class CollectionPortalbox_15_51_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_51
        score = 95
        collection = CollectionData.articlesPreprints
    ...
    class CollectionPortalbox_16_22_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_22
        score = 100
        collection = CollectionData.booksReports
    ...
    class CollectionPortalbox_16_52_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_52
        score = 95
        collection = CollectionData.booksReports
    ...
    class CollectionPortalbox_17_23_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_23
        score = 100
        collection = CollectionData.multimediaArts
    ...
    class CollectionPortalbox_17_53_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_53
        score = 95
        collection = CollectionData.multimediaArts
    ...
    class CollectionPortalbox_18_24_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_24
        score = 100
        collection = CollectionData.poetry
    ...
    class CollectionPortalbox_19_78_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_78
        score = 100
        collection = CollectionData.atlantisTimesNews
    ...
    class CollectionPortalbox_1_1_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_1
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_25_fr:
        ln = u'fr'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_25
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_26_fr:
        ln = u'fr'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_26
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_27_sk:
        ln = u'sk'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_27
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_28_sk:
        ln = u'sk'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_28
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_29_cs:
        ln = u'cs'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_29
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_2_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_2
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_30_cs:
        ln = u'cs'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_30
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_31_de:
        ln = u'de'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_31
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_32_de:
        ln = u'de'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_32
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_33_es:
        ln = u'es'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_33
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_34_es:
        ln = u'es'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_34
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_35_it:
        ln = u'it'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_35
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_36_it:
        ln = u'it'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_36
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_37_no:
        ln = u'no'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_37
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_38_no:
        ln = u'no'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_38
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_39_pt:
        ln = u'pt'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_39
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_40_pt:
        ln = u'pt'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_40
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_41_ru:
        ln = u'ru'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_41
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_42_ru:
        ln = u'ru'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_42
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_43_sv:
        ln = u'sv'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_43
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_44_sv:
        ln = u'sv'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_44
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_54_el:
        ln = u'el'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_54
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_55_el:
        ln = u'el'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_55
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_56_uk:
        ln = u'uk'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_56
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_57_uk:
        ln = u'uk'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_57
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_58_ca:
        ln = u'ca'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_58
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_59_ca:
        ln = u'ca'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_59
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_60_ja:
        ln = u'ja'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_60
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_61_ja:
        ln = u'ja'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_61
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_62_pl:
        ln = u'pl'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_62
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_63_pl:
        ln = u'pl'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_63
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_64_bg:
        ln = u'bg'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_64
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_65_bg:
        ln = u'bg'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_65
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_66_hr:
        ln = u'hr'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_66
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_67_hr:
        ln = u'hr'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_67
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_68_zhCN:
        ln = u'zh_CN'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_68
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_69_zhCN:
        ln = u'zh_CN'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_69
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_70_zhTW:
        ln = u'zh_TW'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_70
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_71_zhTW:
        ln = u'zh_TW'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_71
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_72_hu:
        ln = u'hu'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_72
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_73_hu:
        ln = u'hu'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_73
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_74_af:
        ln = u'af'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_74
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_75_af:
        ln = u'af'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_75
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_76_gl:
        ln = u'gl'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_76
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_77_gl:
        ln = u'gl'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_77
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_79_ro:
        ln = u'ro'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_79
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_80_ro:
        ln = u'ro'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_80
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_81_rw:
        ln = u'rw'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_81
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_82_rw:
        ln = u'rw'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_82
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_83_ka:
        ln = u'ka'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_83
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_84_ka:
        ln = u'ka'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_84
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_85_lt:
        ln = u'lt'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_85
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_86_lt:
        ln = u'lt'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_86
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_87_ar:
        ln = u'ar'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_87
        score = 100
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_1_88_ar:
        ln = u'ar'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_88
        score = 90
        collection = CollectionData.siteCollection
    ...
    class CollectionPortalbox_20_78_en:
        ...
        portalbox = PortalboxData.Portalbox_78
        score = 100
        collection = CollectionData.atlantisTimesArts
    ...
    class CollectionPortalbox_21_78_en:
        ...
        portalbox = PortalboxData.Portalbox_78
        score = 100
        collection = CollectionData.atlantisTimesScience
    ...
    class CollectionPortalbox_22_78_en:
        ...
        portalbox = PortalboxData.Portalbox_78
        score = 100
        collection = CollectionData.atlantisTimes

    class CollectionPortalbox_26_89_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_89
        score = 100
        collection = CollectionData.notes

    class CollectionPortalbox_27_90_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_90
        score = 100
        collection = CollectionData.ALEPHPapers

    class CollectionPortalbox_28_91_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_91
        score = 100
        collection = CollectionData.ALEPHInternalNotes

    class CollectionPortalbox_29_92_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_92
        score = 100
        collection = CollectionData.ALEPHTheses

    class CollectionPortalbox_2_45_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_45
        score = 95
        collection = CollectionData.preprints
    ...
    class CollectionPortalbox_2_5_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_5
        score = 100
        collection = CollectionData.preprints
    ...
    class CollectionPortalbox_2_6_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_6
        score = 90
        collection = CollectionData.preprints
    ...
    class CollectionPortalbox_30_93_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_93
        score = 100
        collection = CollectionData.ISOLDEPapers

    class CollectionPortalbox_31_94_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_94
        score = 100
        collection = CollectionData.ISOLDEInternalNotes

    class CollectionPortalbox_32_95_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_95
        score = 100
        collection = CollectionData.drafts

    class CollectionPortalbox_3_46_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_46
        score = 95
        collection = CollectionData.books
    ...
    class CollectionPortalbox_3_7_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_7
        score = 100
        collection = CollectionData.books
    ...
    class CollectionPortalbox_3_8_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_8
        score = 90
        collection = CollectionData.books
    ...
    class CollectionPortalbox_4_10_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_10
        score = 90
        collection = CollectionData.theses
    ...
    class CollectionPortalbox_4_47_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_47
        score = 95
        collection = CollectionData.theses
    ...
    class CollectionPortalbox_4_9_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_9
        score = 100
        collection = CollectionData.theses
    ...
    class CollectionPortalbox_5_11_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_11
        score = 100
        collection = CollectionData.reports
    ...
    class CollectionPortalbox_5_48_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_48
        score = 95
        collection = CollectionData.reports
    ...
    class CollectionPortalbox_6_3_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_3
        score = 100
        collection = CollectionData.articles
    ...
    class CollectionPortalbox_6_49_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_49
        score = 95
        collection = CollectionData.articles
    ...
    class CollectionPortalbox_6_4_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_4
        score = 90
        collection = CollectionData.articles
    ...
    class CollectionPortalbox_8_14_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_14
        score = 100
        collection = CollectionData.pictures
    ...
    class CollectionPortalbox_8_50_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_50
        score = 95
        collection = CollectionData.pictures
    ...
    class CollectionPortalbox_9_15_en:
        ln = u'en'
        position = u'rt'
        portalbox = PortalboxData.Portalbox_15
        score = 100
        collection = CollectionData.CERNDivisions
...
class CollectionFieldFieldvalueData(DataSet):
    class CollectionFieldFieldvalue_2_7_7:
        ...
        fieldvalue = FieldvalueData.Fieldvalue_7.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 18
    ...
    class CollectionFieldFieldvalue_2_7_6:
        collection = CollectionData.preprints
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_6.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 19
    ...
    class CollectionFieldFieldvalue_2_7_5:
        collection = CollectionData.preprints
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_5.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 20
    ...
    class CollectionFieldFieldvalue_2_7_4:
        collection = CollectionData.preprints
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_4.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 21
    ...
    class CollectionFieldFieldvalue_6_7_1:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_1.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 24
    ...
    class CollectionFieldFieldvalue_6_7_2:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_2.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 23
    ...
    class CollectionFieldFieldvalue_6_7_3:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_3.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 22
    ...
    class CollectionFieldFieldvalue_6_7_8:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_8.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 17
    ...
    class CollectionFieldFieldvalue_6_7_9:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_9.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 16
    ...
    class CollectionFieldFieldvalue_6_7_10:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_10.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 15
    ...
    class CollectionFieldFieldvalue_6_7_11:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_11.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 14
    ...
    class CollectionFieldFieldvalue_6_7_12:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_12.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 13
    ...
    class CollectionFieldFieldvalue_6_7_13:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_13.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 12
    ...
    class CollectionFieldFieldvalue_6_7_14:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_14.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 11
    ...
    class CollectionFieldFieldvalue_6_7_15:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_15.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 10
    ...
    class CollectionFieldFieldvalue_6_7_16:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_16.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 9
    ...
    class CollectionFieldFieldvalue_6_7_17:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_17.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 8
    ...
    class CollectionFieldFieldvalue_6_7_18:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_18.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 7
    ...
    class CollectionFieldFieldvalue_6_7_19:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_19.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 6
    ...
    class CollectionFieldFieldvalue_6_7_20:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_20.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 5
    ...
    class CollectionFieldFieldvalue_6_7_21:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_21.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 4
    ...
    class CollectionFieldFieldvalue_6_7_22:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_22.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 3
    ...
    class CollectionFieldFieldvalue_6_7_23:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_23.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 2
    ...
    class CollectionFieldFieldvalue_6_7_24:
        collection = CollectionData.articles
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_24.ref('id')
        type = 'seo'
        score = 2
        score_fieldvalue = 1
    ...
    class CollectionFieldFieldvalue_6_11_25:
        ...
        fieldvalue = FieldvalueData.Fieldvalue_25.ref('id')
        type = 'seo'
        score = 1
        score_fieldvalue = 1
    ...
    class CollectionFieldFieldvalue_6_11_26:
        collection = CollectionData.articles
        field = FieldData.Field_11
        fieldvalue = FieldvalueData.Fieldvalue_26.ref('id')
        type = 'seo'
        score = 1
        score_fieldvalue = 2
    ...
    class CollectionFieldFieldvalue_8_7_27:
        collection = CollectionData.pictures
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_27.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 3
    ...
    class CollectionFieldFieldvalue_8_7_28:
        collection = CollectionData.pictures
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_28.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 1
    ...
    class CollectionFieldFieldvalue_8_7_29:
        collection = CollectionData.pictures
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_29.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 4
    ...
    class CollectionFieldFieldvalue_8_7_30:
        collection = CollectionData.pictures
        field = FieldData.Field_7
        fieldvalue = FieldvalueData.Fieldvalue_30.ref('id')
        type = 'seo'
        score = 10
        score_fieldvalue = 2
    ...
    class CollectionFieldFieldvalue_2_11_32:
        collection = CollectionData.preprints
        field = FieldData.Field_11
        fieldvalue = FieldvalueData.Fieldvalue_32.ref('id')
        type = 'seo'
        score = 5
        score_fieldvalue = 0
    ...
    class CollectionFieldFieldvalue_34_33_None:
        collection = CollectionData.Collection_34
    ...
    class CollectionFieldFieldvalue_35_33_None:
        collection = CollectionData.Collection_35
        field = FieldData.Field_33
        fieldvalue = None
        type = 'sew'
        score = 1
    ...
    class CollectionFieldFieldvalue_36_34_None:
        collection = CollectionData.Collection_36
        field = FieldData.Field_34
        fieldvalue = None
        type = 'sew'
        score = 1
    ...
    class CollectionFieldFieldvalue_37_35_None:
        collection = CollectionData.Collection_37
        field = FieldData.Field_35
        fieldvalue = None
        type = 'sew'
        score = 1
    ...
    class CollectionFieldFieldvalue_38_36_None:
        collection = CollectionData.Collection_38
        field = FieldData.Field_36
        fieldvalue = None
        type = 'sew'
        score = 1
